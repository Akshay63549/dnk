...
const contactus = () => {
    ...
    useEffect(() => {
      ...
      const handleScroll = () => {
        const element = document.getElementById('yourComponent3'); // Set the ID of your component
        const rect = element.getBoundingClientRect();
        const viewportHeight = window.innerHeight || document.documentElement.clientHeight;
  
        // Check if the component is at least 20 pixels in the viewport
        setIsVisible(rect.top <= viewportHeight - 20);
      };
  ...
  <div  id="yourComponent3"  className={`max-w-6xl mx-auto bg-white mt-28 font-[sans-serif] text-[#011c2b] ${isVisible ? 'animate-fade-in-up opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
  ...
  <div className="grid lg:grid-cols-3 items-center gap-4 p-2 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-lg mt-8">
    <div className="bg-emerald-800 rounded-lg p-6 max-lg:text-center">
      ...
      <form>
        <div className="grid sm:grid-cols-2 gap-8">
          ...
          <div className="relative flex items-center sm:col-span-2">
            <textarea placeholder="Write Message" className="px-2 pt-3 bg-white text-black w-full text-sm border-b-2 focus:border-[#011c2b] outline-none" defaultValue={""} />
            <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" className="w-[18px] h-[18px] absolute right-2" viewBox="0 0 682.667 682.667">
              <defs>
                <clipPath id="a" clipPathUnits="userSpaceOnUse">
                  <path d="M0 512h512V0H0Z" data-original="#000000" />
        ...
        <button type="button" className="mt-12 flex items-center justify-center text-sm lg:ml-auto max-lg:w-full rounded px-4 py-2.5 font-semibold bg-emerald-600 text-white hover:bg-emerald-800">
