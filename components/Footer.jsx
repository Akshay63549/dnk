...
const FooterItem = ({ text, link }) => {
    ...
    const Footer = () => {
        ...
        useEffect(() => {
          ...
          const handleScroll = () => {
            const element = document.getElementById('yourComponent2'); // Set the ID of your component
    ...
    return (
        <footer id="yourComponent2"  className={`pt-2  ${isVisible ? 'animate-blurred-fade-in opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
            <div className="px-2 sm:px-0">
                <div className="mx-auto w-full max-w-6xl bg-emerald-600 dark:bg-blue-950 p-5 sm:p-10 py-10 sm:py-14 md:py-16 rounded-3xl relative overflow-hidden">
