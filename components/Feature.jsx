...
const iconRender = (val) => {
    ...
    const Features = () => {
      ...
      useEffect(() => {
        ...
        const handleScroll = () => {
          const element = document.getElementById('yourComponent'); // Set the ID of your component
    ...
    return (
        <section  id="yourComponent"  className={`py-20  ${isVisible ? 'animate-expand-vertically opacity-100 translate-y-0' : 'opacity-0 translate-y-20'}`}>
            <div className="max-w-7xl mx-auto px-5 sm:px-10 md:px-12 lg:px-5 flex flex-col md:flex-row gap-10 xl:gap-14">
                ...
                <div className="w-full md:h-auto object-cover flex md:items-end justify-center md:w-1/2 xl:w-[45%] relative">
                    ...
                    <img src="https://tailwind.unify-ui.dev/prev/images/woman-with-gro.webp" width={1001} height={1001} alt="woman with grocery" className="wfull h-auto lg:w-[86%] relative" />
                </div>
            </div>
        </section>
    )
